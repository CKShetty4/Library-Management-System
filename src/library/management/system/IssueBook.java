...
// New method to initialize issue and due dates
    private void initializeDates() {
        SimpleDateFormat dat = new SimpleDateFormat("dd/MM/yyyy ");
        Date d = new Date(); // Current date
        txtissuedate.setText(dat.format(d)); // Set issue date

        Calendar cal = Calendar.getInstance();
        cal.setTime(d); // Set the current date
        cal.add(Calendar.DAY_OF_YEAR, 9); // Add 9 days (7 days + 2 extra days)

        // Calculate and set due date
        Date dueDate = cal.getTime();
        txtduedate.setText(dat.format(dueDate));
    }
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(1370, 950));
        setUndecorated(true);
        ...
        getContentPane().add(txtstudentid, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 290, 350, 50));
        ...
        getContentPane().add(txtbookname, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 410, 350, 50));
        ...
        getContentPane().add(txtissuedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 530, 350, 50));
        ...
        getContentPane().add(txtduedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 650, 350, 50));

        btnissue.setBackground(new java.awt.Color(204, 0, 51));
        btnissue.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        getContentPane().add(btnissue, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 780, 150, 50));
        ...
        getContentPane().add(btnsearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(883, 170, 100, 50));
